        ...
        {menuState && (
            <>
                ...
                className="products">
                    ...
                    <div className="close" onClick={()=>setMenuState(false)}
...
transition={{ease:"linear"}}
					...
					<div className={`line right flex-${rightLineFlex}`}>
                        <motion.div 
                            variants={maskAnimation} transition={{ ...transition, duration: 1 }}
...
const Panels = ()=>{
    ...
    return(
        ...
        animate={{  height:[0, window.innerHeight,0], bottom:[null, 0, 0]}}
                ...
                transition={{ ...transition, duration: 2, times: [0,.05,1]  }}
